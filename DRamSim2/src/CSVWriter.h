...
namespace DRAMSim
{
	...
	public: 
		...
		CSVWriter &operator<<(unsigned value)
		{
			if (finalized)
			{
				output << value << ",";
		...
		CSVWriter &operator<<(uint64_t value)
		{
			if (finalized)
			{
				output << value << ",";
		...
		CSVWriter &operator<<(double value)
		{
			if (finalized)
			{
				output << value << ",";
		...
		CSVWriter &operator<<(float value)
		{
			if (finalized)
			{
				output << value << ",";
